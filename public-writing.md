...
<section class="page-header">
  <p class="eyebrow">Escrita Pública</p>
  <h1 class="page-title">Artigos de Opinião e Ensaios</h1>
  <p class="page-intro">Seleção de artigos de opinião e ensaios, majoritariamente em português.</p>
</section>

<section class="section-block" aria-labelledby="op-eds-list">
  <h2 id="op-eds-list">Artigos de Opinião</h2>
  <ol class="timeline">
    <li>
    ...
    <li>
      ...
      <br>
      1 fev 2021 · Folha de S.Paulo (com Fernanda Campagnucci e Laila Belix)
    </li>
    <li>
