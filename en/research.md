...
language: en
lang_code: en-US
alt_lang_url: /research/
title: Research
permalink: /en/research/
description: Working papers and publications by Manoel Galdino.
---
...
<section class="section-block" aria-labelledby="central-project">
  ...
  <div class="paper-list">
    ...
    <article class="paper-card">
      <h3><a hreflang="pt-BR" href="{{ '/research/when-weak-states-win/' | relative_url }}">When Weak States Win: A Supermodular Game-Theoretic Account of the 2006 Bolivia-Brazil Gas Crisis</a></h3>
      <p class="paper-meta">With Rodrigo Lyra. Published in <em>Revista Brasileira de Política Internacional (RBPI)</em>, 69(1), e004, 2026. Open access. The linked publication page is in Portuguese.</p>
      <details>
        <summary>Abstract</summary>
...
<section class="section-block" aria-labelledby="methods">
  ...
  <div class="paper-list">
    ...
    <article class="paper-card">
      ...
      <p class="paper-meta">Status: submitted to <em>Brazilian Political Science Review (BPSR)</em>. Version dated 2024-06-30.</p>
      <details>
        <summary>Abstract</summary>
...
<section class="section-block" aria-labelledby="books">
  <h2 id="books">Book Manuscripts (Portuguese)</h2>
