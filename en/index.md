...
<section class="bio-layout" aria-labelledby="bio-overview">
  ...
  <aside class="profile-card" aria-labelledby="profile-and-links">
    <h2 id="profile-and-links">Profile and Links</h2>
    <p><strong>Email:</strong> <a href="mailto:{{ site.email }}">{{ site.email }}</a></p>
    <p><strong>Department:</strong> Universidade de São Paulo</p>
    <p><strong>Lab:</strong> <a href="{{ '/en/csex/' | relative_url }}">CSEX Lab</a></p>
    <p><strong>Program:</strong> PET Social Sciences (Tutor)</p>
    <ul class="simple-list">
      <li><a href="{{ site.cv_url }}">Lattes CV</a></li>
      <li><a href="{{ site.social.github }}">GitHub</a></li>
      <li><a href="{{ site.social.bluesky }}">Bluesky</a></li>
      <li><a href="{{ '/public-writing/' | relative_url }}">Public Writing (PT)</a></li>
    </ul>
  </aside>
</section>
...
<section aria-labelledby="featured-research">
  ...
  <div class="featured-grid">
    ...
    <article class="featured-card">
      ...
      <div class="featured-body">
        <h3>Bottom-Up Accountability</h3>
        <p>Field experimental evidence on local oversight and public service delivery.</p>
        <a class="callout-link" href="https://journals.sagepub.com/doi/full/10.1177/2053168020914444">Read article &gt;</a>
      </div>
    </article>
    ...
    <article class="featured-card">
      <div class="featured-top blue"></div>
      <div class="featured-body">
        <h3>Moral Framing and Political Engagement</h3>
        <p>Experimental evidence on moral foundations and political engagement in social media.</p>
        <a class="callout-link" href="https://github.com/juliatachima/MFT_IC/blob/main/Manuscripts/article_MFT_Galdino_Tachima.pdf">Read manuscript &gt;</a>
      </div>
    </article>
  </div>
</section>
...
<section class="section-block" aria-labelledby="students-and-collaboration">
  <h2 id="students-and-collaboration">Students and Collaboration</h2>
  <p>I welcome students and collaborators interested in empirical political science projects with clear identification strategies and reproducible analysis.</p>
  <ol class="simple-list">
    <li>Read the research page and identify one paper or agenda connected to your interests.</li>
    <li>Send a short email with your stage (undergraduate, MA, PhD) and a concrete research question.</li>
    <li>Include your CV and, if possible, one writing sample.</li>
  </ol>
</section>
